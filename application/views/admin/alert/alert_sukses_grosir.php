...
<head>
    ...
    <meta name="description" content="Produk By Itandi Nusantara">
    <meta name="author" content="Itandi Nusantara">
   ...
   ?>
    ...
    <div class="container">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo date('Y');?> by Itandi Nusantara</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
